...
@interface CALayer (XUNUIKit)
@property CGFloat xun_x;
@property CGFloat xun_y;
@property CGFloat xun_width;
@property CGFloat xun_height;

@property CGFloat xun_anchorPointX;
@property CGFloat xun_anchorPointY;

/// 【谨慎使用】当 anchorPoint.x != 0.5 时，存在问题
@property CGFloat xun_centerX;
/// 【谨慎使用】当 anchorPoint.y != 0.5 时，存在问题
@property CGFloat xun_centerY;
@property CGPoint xun_origin;
@property CGSize  xun_size;
/// 【谨慎使用】当 anchorPoint != {0.5, 0.5} 时，存在问题
@property CGPoint xun_center;
...
/// 子视图右侧与父视图右侧距离【需先添加至父视图】
@property (readonly) CGFloat xun_trailingRight;
/// 子视图底部与父视图底部距离【需先添加至父视图】
